                ...
                <div className="container">
                    <div className="row mx-5">
                        <div className="col-lg-6">
                            {user && <h2 className="mt-5">Welcome to I love LAW, {user.name}!</h2>}
            ...
            <section className="container">
                ...
                <div className="container text-center mb-3">
                    <div className="row justify-content-around mt-2">
                        <div className="col-lg-6 col-sm-8 d-flex justify-content-center mb-3">
                            <div className="card mx-auto" style={{borderColor: '#283770', maxWidth: "18rem"}}>
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <a href="/search-by-title" className="btn btn-sm btn-outline-blue">Search</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-sm-8 d-flex justify-content-center mb-3">
                            <div className="card mx-auto" style={{borderColor: '#283770', maxWidth: "18rem"}}>
                                ...
                                <div className="card-body text-center">
                                    ...
                                    <a href="/genre-list" className="btn btn-sm btn-outline-blue">Search</a>
                                </div>
                            </div>
                        </div>
