            ...
            <div className="row justify-content-around mt-2">
              <div className="col-lg-4 col-sm-6 d-flex justify-content-center mb-3">
                <div
                    ...
                    style={{ borderColor: "#283770", maxWidth: "18rem" }}
                >
                  <div
                      className="card-header text-center text-white"
                      style={{ backgroundColor: "#283770" }}
                  >
                    Convert PDFs
                  </div>
                  <div className="card-body text-center">
                    ...
                    <p className="card-text my-3">
                      Convert Your PDFs to JPG Images in a Zip File.
                    </p>
                    <a href="/convert" className="btn btn-sm btn-outline-blue">
                      Go To Page
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-sm-6 d-flex justify-content-center mb-3">
                ...
                >
                  ...
                  <div className="card-body text-center">
                    ...
                    <p className="card-text my-3">
                      The Complete List of Your PDFs to JPG Conversions.
                    </p>
                    <a href="/history" className="btn btn-sm btn-outline-blue">
                      Go To Page
                    </a>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-sm-6 d-flex justify-content-center mb-3">
                ...
                >
                  ...
                  <div className="card-body text-center">
                    ...
                    <p className="card-text my-3">
                      The Notification of Your PDFs to JPG Conversions.
                    </p>
                    <a
                        href="/notification"
