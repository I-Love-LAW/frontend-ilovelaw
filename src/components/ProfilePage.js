                ...
                <div className="card-body">
                            ...
                            <div className="col-12">
                                <div className="row">
                                    ...
                                    <div className="col-10">
                                        <div className="mb-3">
                                            <label htmlFor="formGroupExampleInput1" className="form-label">Username <span
                        ...
                        <div className="row my-3">
                            <div className="col-12">
                                <div className="row">
                                    ...
                                    <div className="col-10">
                                        <div className="mb-3">
                                            <label htmlFor="formGroupExampleInput2" className="form-label">Nama <span
                                                style={{color: "red"}}>*</span></label>
                                            <input type="text" value={name}
                                                   className="form-control input-text border-blue rounded-3 border-1"
                                                   id="formGroupExampleInput2" required onChange={(e) => setName(e.target.value)}/>
                                        </div>
                                    </div>
                                    <div className="col-1"></div>
                                </div>
                    ...
                    <div className="row mt-5 mb-3">
                        ...
                        <div className="col-2 text-center">
                            <button type="submit" className="btn btn-blue btn-lg" data-toggle="modal"
                                    data-target="#exampleModal" onClick={submit}
                                    id="submit1">
                                Ubah
                            </button>
                        </div>
